...
export class CreatePlaybookDto {
  @ApiProperty({
    description: 'Título del playbook',
    example: 'Manejo de objeción de precio',
  })
  @IsString()
  title: string;
  ...
  @ApiPropertyOptional({
    description: 'Triggers/condiciones para activar',
    type: [String],
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiPropertyOptional({
    description: 'Prioridad (mayor = más importante)',
    default: 0,
  })
  @IsOptional()
  @IsNumber()
